...
public class RMFreeDrawView extends View implements View.OnTouchListener {
    ...
    private void initPaints(TypedArray a) {
        ...
        mCurrentPaint.setColor(a != null ? a.getColor(R.styleable.RMFreeDrawView_paintColor,
                mPaintColor) : mPaintColor);
        mCurrentPaint.setAlpha(a != null ?
                a.getInt(R.styleable.RMFreeDrawView_paintAlpha, mPaintAlpha)
                : mPaintAlpha);
        mCurrentPaint.setStrokeWidth(a != null ?
                a.getDimensionPixelSize(R.styleable.RMFreeDrawView_paintWidth,
        ...
        if (a != null) {
            int resizeBehaviour = a.getInt(R.styleable.RMFreeDrawView_resizeBehaviour, -1);
